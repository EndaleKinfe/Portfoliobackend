...
const Navbar = () => {
    ...
    return ( 
        <nav className='sticky z-50 top-0 left-0 bg-white grid  grid-cols-2 justify-items-center items-center md:justify-around dark:bg-slate-600 md:flex space-x-5 *:my-2 *:py-1 lg:space-x-10 xl:space-x-20  h-full'>
